              ...
              <div className="navbar col-sm-12" role="navigation">
                <div className="navbar-header">
                  ...
                  <a className="brand" href="#">
                    <img height="200" width="180" src="logo.png" alt="Vanes" />
                  </a>
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-8 col-sm-offset-2">
                <h3>
                  You have the Requirement, We have the Experience & Resources
                </h3>
                <div className="row">
                  <p className="lead col-sm-10 col-sm-offset-1">
                    Vanes can help your business to develop any software
                    solution from small to large with decades of experience in
                    the industry.
                  </p>
                </div>
              </div>
